  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <header className="text-center py-20">
        <h1 className="text-5xl font-bold text-purple-400">Alexandra Rodriguez</h1>
        ...
        <div className="mt-6">
          <button className="bg-purple-600 text-white px-6 py-2 rounded-full mr-4 hover:bg-purple-700">View My Work</button>
          <button className="bg-purple-600 text-white px-6 py-2 rounded-full hover:bg-purple-700">Get in Touch</button>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          {projects.map((project, index) => (
            <div key={index} className="bg-gray-800 p-4 rounded-lg">
              ...
              <span className="inline-block mt-4 bg-purple-600 text-white px-2 py-1 rounded-full text-sm">Featured</span>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="contact" className="py-16 text-center">
        ...
        <div className="mt-6">
          <button className="bg-purple-600 text-white px-6 py-2 rounded-full mr-4 hover:bg-purple-700">Email Me</button>
          <button className="bg-purple-600 text-white px-6 py-2 rounded-full hover:bg-purple-700">Call Me</button>
        </div>
      </section>
