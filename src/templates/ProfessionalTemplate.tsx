      ...
      <div className={`min-h-screen ${isPreview ? "scale-50 origin-top-left" : ""}`}>
         <div className="container mx-auto p-4">
            ...
            <header className="text-center py-20">
               <h1 className="text-5xl font-bold text-red-400">{name}</h1>
               <p className="mt-4">{jobRole}</p>
               <p className="mt-2">
                 {bio}
               </p>
               <div className="mt-6">
                  <button className="bg-red-600 text-white px-6 py-2 rounded-full mr-4 hover:bg-red-700">
                     View My Work
                  </button>
            ...
            <section id="about" className="py-16">
               <h2 className="text-3xl font-bold text-red-400 text-center">About Me</h2>
               <div className="flex flex-col md:flex-row mt-8">
                  <div className="md:w-100 text-center p-4">
                     <p>Get to know me</p>
                     <p className="mt-4">
            ...
            <section id="skills" className="py-16">
               <h2 className="text-3xl font-bold text-red-400 text-center">Skills & Expertise</h2>
            ...
            <section id="projects" className="py-16">
               <h2 className="text-3xl font-bold text-red-400 text-center">Featured Projects</h2>
               <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                  {projects.map((project) => (
                     <div key={project.id} className="bg-gray-800 p-4 rounded-lg">
                        <img src={project.projectImage} alt={project.projectTitle} className="w-full h-48 object-cover rounded-lg" />
                        <h3 className="text-xl font-bold mt-4">{project.projectTitle}</h3>
                        <p className="mt-2 text-gray-400">{project.projectSummary}</p>
                        <span className="inline-block mt-4 bg-red-600 text-white px-2 py-1 rounded-full text-sm">
                           Featured
                        </span>
                     </div>
                  ))}
            ...
            <section id="contact" className="py-16 text-center">
               <h2 className="text-3xl font-bold text-red-400">Let's Work Together</h2>
               <p className="mt-4">
