      ...
      <div className={`min-h-screen ${isPreview ? "scale-50 origin-top-left" : ""}`}>
         <div className="container mx-auto p-4">
            ...
            <header className="text-center py-20">
               <h1 className="text-5xl font-bold text-blue-400">{name}</h1>
               <p className="mt-4">{jobRole}</p>
               <p className="mt-2">
                 {bio}
               </p>
               <div className="mt-6">
                  <button className="bg-blue-600 text-white px-6 py-2 rounded-full mr-4 hover:bg-blue-700">
                     View My Work
                  </button>
            ...
            <section id="skills" className="py-16">
               <h2 className="text-3xl font-bold text-blue-400 text-center">Skills & Expertise</h2>
            ...
            <section id="projects" className="py-16">
               <h2 className="text-3xl font-bold text-blue-400 text-center">Featured Projects</h2>
               <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                  {projects.map((project) => (
                     <div key={project.id} className="bg-gray-800 p-4 rounded-lg">
                        ...
                        <span className="inline-block mt-4 bg-blue-600 text-white px-2 py-1 rounded-full text-sm">
                           Featured
                        </span>
                     </div>
                  ))}
            ...
            <section id="contact" className="py-16 text-center">
               <h2 className="text-3xl font-bold text-blue-400">Let's Work Together</h2>
               <p className="mt-4">
